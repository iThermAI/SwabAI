...
def allocate_buffers(engine, batch_size, data_type):
    ...
    # Determine dimensions and create page-locked memory buffers (which won't be swapped to disk) to hold host inputsoutputs.
    ...
    # Create a stream in which to copy inputsoutputs and run inference.
    stream = cuda.Stream()
